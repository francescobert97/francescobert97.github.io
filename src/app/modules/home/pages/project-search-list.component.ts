import { ChangeDetectorRef, Component, OnInit, ɵCodegenComponentFactoryResolver } from '@angular/core';
...
export class ProjectSearchListComponent implements OnInit {
  ...
  private updateLocalStorage() {
    ...
    const projectObj =  JSON.parse(localStorage.getItem('projectData') as string);
