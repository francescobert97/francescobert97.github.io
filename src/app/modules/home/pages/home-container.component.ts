...
@Component({
  selector: 'app-home',
  template: `
    <div class="home-container m-0 w-100 row g-0 " [class]="secondAnimation? 'second-animation' : null">
      <div class="text-light d-flex flex-column  col-sm-10 mx-sm-auto col-12">
